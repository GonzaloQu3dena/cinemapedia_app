...
void _movieSerialize(
  ...
  writer.writeBool(offsets[2], object.hasVideo);
  writer.writeLong(offsets[3], object.id);
  writer.writeBool(offsets[4], object.isAdult);
...
Movie _movieDeserialize(
  ...
  final object = Movie(
    ...
    hasVideo: reader.readBool(offsets[2]),
    id: reader.readLong(offsets[3]),
    isAdult: reader.readBool(offsets[4]),
...
extension MovieQueryFilter on QueryBuilder<Movie, Movie, QFilterCondition> {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> isAdultEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isAdult',
        value: value,
...
extension MovieQuerySortBy on QueryBuilder<Movie, Movie, QSortBy> {
  ...
  QueryBuilder<Movie, Movie, QAfterSortBy> sortByIsAdult() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isAdult', Sort.asc);
    });
  }

  QueryBuilder<Movie, Movie, QAfterSortBy> sortByIsAdultDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension MovieQuerySortThenBy on QueryBuilder<Movie, Movie, QSortThenBy> {
  ...
  QueryBuilder<Movie, Movie, QAfterSortBy> thenByIsAdult() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isAdult', Sort.asc);
    });
  }

  QueryBuilder<Movie, Movie, QAfterSortBy> thenByIsAdultDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isAdult', Sort.desc);
    });
  }
...
extension MovieQueryWhereDistinct on QueryBuilder<Movie, Movie, QDistinct> {
  ...
  QueryBuilder<Movie, Movie, QDistinct> distinctByIsAdult() {
    return QueryBuilder.apply(this, (query) {
...
extension MovieQueryProperty on QueryBuilder<Movie, Movie, QQueryProperty> {
  ...
  QueryBuilder<Movie, bool, QQueryOperations> isAdultProperty() {
    return QueryBuilder.apply(this, (query) {
